...
Per ciascuno di questi 8 eventi SEP sono stati scaricati i dati di flussi differenziali protonici dalle più note missioni satellitari come GOES, ACE, STEREO e IMP-8, tramite principalmente 2 portali, il primo è il sito della Nasa "OMNIWeb" che raccoglie dati controllati e in formato standardizzato da molteplici missioni, principalmente GOES e ACE; il secondo è stato il catalogo SEPEM RDS v3.0, un database realizzato dall'agenzia spaziale europea (ESA) che raccoglie dati di eventi SEP dal 1973 fino ad oggi. 
I satelliti utilizzati hanno detector che misurano i protoni in vari canali energetici, il range energetico varia da pochi KeV fino al GeV. Per i satelliti GOES ad esempio, quando possibile sono stati combinati i dati dai canali EPS (basse energie P2-P7) e HEPAD (alte energie P8-P11). Si tratta di flussi differenziali time-averaged in risoluzione temporale da 1-15 minuti.

I dati scaricati sono stati puliti secondo la seguente procedura: 
\begin{itemize}
    \item[-] Resampling standard per tutti e 8 con media temporale di 30 minuti per ridurre spike e fluttuazioni statistiche 

    \item[-] Selezione di un intervallo temporale tipicamente di circa 15gg nel periodo precedente all'evento, per stimare il fondo di rumore strumentale e GCR

    \item[-] Metodo pulizia Whitman: sul periodo di background si calcola la media $\mu$ e la deviazione standarda
\end{itemize}
