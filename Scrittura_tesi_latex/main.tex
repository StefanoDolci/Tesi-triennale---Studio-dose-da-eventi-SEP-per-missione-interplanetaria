...
\end{figure}
Successivamente sono state calcolate le fluenze integrali, i risultati sono riportati nella seguente tabella:
\begin{table}[h]
\centering
\resizebox{\textwidth}{!}{%
\begin{tabular}{
