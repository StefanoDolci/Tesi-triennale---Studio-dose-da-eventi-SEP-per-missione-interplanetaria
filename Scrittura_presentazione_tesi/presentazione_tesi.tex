    ...
    \begin{columns}
        \begin{column}{0.58\textwidth}
            \begin{itemize}
                ...
                \item \textbf{Obiettivo}: stimare la dose da protoni SEP che una sonda accumulerebbe per un transito Terra--Marte
            \end{itemize}
        \end{column}
...
\begin{frame}{Effetti della radiazione sull'elettronica}
	\begin{itemize}
